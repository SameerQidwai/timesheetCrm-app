...
const TimesheetAttachment = ({ fileModelEvent, setFileModelEvent, onSuccess }) => {
  ...
  console.log("fileModelEvent-->", fileModelEvent);
  ...
  const onSubmit = () => {
    ...
    let data = { note: formState.values.note, attachments: formState.values.fileId?[formState.values.fileId] : [], milestoneEntryIds: [fileModelEvent.milestoneEntryId] };
